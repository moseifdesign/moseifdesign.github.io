# Mohamed Seif Portfolio — V28

Open index.html beside the four WebP files. Modular source is also included.

V28 increases floating thumbnails by 12%, tracks scroll input directly from page origin, and introduces the custom moseif wordmark with a matching favicon.
